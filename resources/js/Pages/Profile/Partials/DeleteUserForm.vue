...
<template>
    <div class="flex flex-col gap-4">
        <p class="text-sm leading-relaxed text-neutral-500">
            ...
            supprimer votre compte, téléchargez toute donnée que vous souhaitez conserver.
        </p>

        <div>
            <AppButton variant="danger" @click="confirm"> <Trash2 :size="14" /> Supprimer mon compte </AppButton>
        </div>
        ...
        <DialogModal :show="confirmingDeletion" @close="closeModal">
            ...
            <template #content>
                <p class="mb-4 text-sm text-neutral-600">
                    Êtes-vous sûr de vouloir supprimer votre compte ? Cette action est irréversible. Entrez votre mot de

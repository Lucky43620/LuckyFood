    ...
    <form @submit.prevent="submit" class="flex flex-col gap-4">
        ...
        <div v-if="$page.props.jetstream.managesProfilePhotos" class="flex items-center gap-4">
            ...
            <div class="relative shrink-0">
                <img
                    ...
                    :alt="user.name"
                    class="h-16 w-16 rounded-full bg-neutral-100 object-cover"
                />
                <div
                    v-else
                    class="h-16 w-16 rounded-full bg-cover bg-center bg-no-repeat"
            ...
            <div class="flex gap-2">
                <button
                    type="button"
                    @click="selectPhoto"
                    class="inline-flex h-8 items-center gap-1.5 rounded-md bg-neutral-100 px-3 text-xs font-semibold text-neutral-600 transition-colors hover:bg-neutral-200 hover:text-neutral-800"
                >
                ...
                <button
                    ...
                    type="button"
                    @click="deletePhoto"
                    class="inline-flex h-8 items-center gap-1.5 rounded-md bg-red-50 px-3 text-xs font-semibold text-red-500 transition-colors hover:bg-red-100 hover:text-red-600"
                >
        ...
        <div class="flex flex-col gap-1.5">
            ...
            <div v-if="$page.props.jetstream.hasEmailVerification && user.email_verified_at === null" class="mt-0.5">
                ...
                <p v-if="verificationLinkSent" class="mt-1 text-xs text-green-600">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="flex flex-col gap-1.5">
                ...
                <p v-if="form.errors.fatsecret_region" class="text-xs text-red-500">
                    {{ form.errors.fatsecret_region }}
                </p>
            </div>
            <div class="flex flex-col gap-1.5">
                ...
                <p v-if="form.errors.fatsecret_language" class="text-xs text-red-500">
                    {{ form.errors.fatsecret_language }}
                </p>
            </div>
        </div>
        ...
        <div class="flex items-center gap-3 pt-2">
            ...
            <Transition name="fade">
                <span
                    ...
                    class="flex items-center gap-1 text-xs font-semibold text-green-600"
                >

...
<template>
    <AuthLayout title="Double authentification">
        <div class="mb-8 text-center">
            ...
            <h2 class="mb-2 font-display text-[24px] leading-tight text-neutral-900">Double authentification</h2>
            <p class="text-sm leading-relaxed text-neutral-500">
                <template v-if="!recovery"> Entrez le code généré par votre application d'authentification. </template>
                <template v-else> Entrez l'un de vos codes de récupération d'urgence. </template>
            </p>
        </div>
        ...
        <form @submit.prevent="submit" class="flex flex-col gap-4">
            ...
            <div class="flex items-center justify-between">
                <button type="button" class="text-sm text-green-600 hover:underline" @click.prevent="toggleRecovery">

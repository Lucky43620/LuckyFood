...
const remaining = computed(() => Math.max(props.goal - props.eaten + props.burned, 0))
  ...
  <div class="relative w-40 h-40 mx-auto">
    <svg width="160" height="160" viewBox="0 0 160 160" class="-rotate-90" aria-hidden="true">
      ...
      <circle
        v-if="overPct > 0"
        cx="80" cy="80" :r="R"
        fill="none" stroke-width="14" stroke-linecap="round" opacity="0.75"
    ...
    <div class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
      ...
      <span class="text-[11px] font-medium text-neutral-400 mt-1.5">kcal consommés</span>
    </div>
  </div>
</template>

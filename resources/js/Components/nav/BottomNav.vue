...
<template>
  <nav class="md:hidden fixed bottom-0 inset-x-0 bg-white border-t border-neutral-100 z-50 safe-area-inset-bottom">
    <div class="flex">
      <Link
        v-for="item in NAV_ITEMS"
        :key="item.id"
        :href="item.href()"
        class="flex-1 flex flex-col items-center gap-1 py-2.5 transition-colors duration-150"
